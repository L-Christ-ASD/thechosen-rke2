...
#================================================================================================
  ...
  #=========================================================================
    ...
    - name: Labeliser les nodes et les patcher avec aws & k8s
      run: |
        export KUBECONFIG=.kube/config-rke2
  ...
  #===========================================================================
    ...
    - name: Lister le svc traefik  déployés dans thechosen 
      run: |
        export KUBECONFIG=.kube/config-rke2
...
#-----------------------------------------------------------------
    ...
    # # - name: Ajouter la clé API DuckDNS dans un Secret pour traefik
    # #   run: |
    # #     export KUBECONFIG=.kube/config-rke2
